...
// Hamburger not working currently
export default function AdminNavbarWithSidebar(props) {
    return (
        <div>
            <nav className="bg-white border-b border-gray-200 fixed z-30x w-full">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <a href="https://demo.themesberg.com/windster/" className="text-xl font-bold flex items-center lg:ml-2.5">
                                <img src={iit_ropar_logo_clear} className="h-6 mr-2" alt="Windster Logo" />
                                <span className="self-center whitespace-nowrap">Admin Dashboard</span>
                            </a>
            ...
            <div className="flex overflow-hidden bg-white pt-[61px]">
                        ...
                        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                                <ul className="space-y-2 pb-2">
                                    ...
                                    <li>
                                        <a href={window.location.origin + "/logout"} className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                            <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="space-y-2 pt-2">
                                    <button className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                        <img className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" src={SignOutIcon}/>
