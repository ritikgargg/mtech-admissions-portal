    ...
    <div>
      <Tooltip title="Delete">
        {/* <Button onClick={handleOpen} style={{color: "rgb(184,184,184)", fontSize: "0.875rem", textTransform: "none"}}>
         ...
         <button onClick={handleOpen} type="button" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" /></svg>
         </button>
      </Tooltip>
      <Modal
      ...
      >
        <Box sx={style}>
          <div className="relative w-full h-full md:h-auto" id="modal-modal-description">
              <div className="bg-white rounded-lg shadow relative">
                ...
                <div className="p-6 pt-0 text-center">
                  ...
                  <a onClick={handleClose} href="#" className="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center">
                    No, cancel
                  </a>
                </div>
              </div>
