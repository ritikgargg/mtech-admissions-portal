        ...
        <Box sx={style}>
          ...
          >
            <h2 className="text-xl font-bold">
              Are you sure you want to re-apply for <span className="italic font-semibold">{props.application.specialization}</span>?
            </h2>
            <p className="mt-2 text-sm text-gray-500">
              The existing application will be replaced on successful re-submission.
            </p>
            <div className="flex items-center justify-end mt-8 text-xs">
            <Link
                to= {"/re-apply/" + props.application.offering_id}
            >
            <button
                type="button"
