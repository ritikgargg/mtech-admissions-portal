              ...
              <div className="container max-w-7xl px-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-center mt-6">
                        ...
                        <div className="flex items-center justify-center opacity-50 hover:opacity-100
                          ...
                          {/* Linkedin */}
                          <a href="https://www.linkedin.com/in/thisisanshulverma/" target="_blank" rel="noopener noreferrer" className="flex rounded-full hover:bg-indigo-50 h-10 w-10">
                            <i className="mdi mdi-linkedin text-indigo-500 mx-auto mt-2" />
                          </a>
                          {/* Twitter */}
                          <button onClick={() => window.location.href = 'mailto:2019csb1075@iitrpr.ac.in'}  className="focus:outline-none cursor-pointer flex rounded-full hover:bg-blue-50 h-10 w-10">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-center mt-6">
                        ...
                        <div className="flex items-center justify-center opacity-50 hover:opacity-100
                                transition-opacity duration-300">
                          {/* Linkedin */}
                          <a href="https://www.linkedin.com/in/piyush-presannan-6b241b1a9/" target="_blank" rel="noopener noreferrer" className="flex rounded-full hover:bg-indigo-50 h-10 w-10">
                            <i className="mdi mdi-linkedin text-indigo-700 mx-auto mt-2" />
                          </a>
                          {/* Twitter */}
                          <button onClick={() => window.location.href = 'mailto:2019csb1106@iitrpr.ac.in'}  className="focus:outline-none cursor-pointer flex rounded-full hover:bg-blue-50 h-10 w-10">
                            <i className="mdi mdi-email text-blue-400 mx-auto mt-2" />
                          </button>
                          {/* Instagram */}
                          <a href="#" className="flex rounded-full hover:bg-orange-50 h-10 w-10">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-center mt-6">
                        ...
                        <div className="flex items-center justify-center opacity-50 hover:opacity-100
                                transition-opacity duration-300">
                          {/* Linkedin */}
                          <a href="https://www.linkedin.com/in/ritikgargg/" target="_blank" rel="noopener noreferrer" className="flex rounded-full hover:bg-indigo-50 h-10 w-10">
                            <i className="mdi mdi-linkedin text-indigo-700 mx-auto mt-2" />
                          </a>
                          {/* Twitter */}
                          <button onClick={() => window.location.href = 'mailto:2019csb1112@iitrpr.ac.in'}  className="focus:outline-none cursor-pointer flex rounded-full hover:bg-blue-50 h-10 w-10">
                            <i className="mdi mdi-email text-blue-400 mx-auto mt-2" />
                          </button>
                          {/* Instagram */}
                          <a href="#" className="flex rounded-full hover:bg-orange-50 h-10 w-10">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-center mt-6">
                        ...
                        <div className="flex items-center justify-center opacity-50 hover:opacity-100
                                transition-opacity duration-300">
                          {/* Linkedin */}
                          <a href="https://www.linkedin.com/in/tarun-singla/" target="_blank" rel="noopener noreferrer" className="flex rounded-full hover:bg-indigo-50 h-10 w-10">
                            <i className="mdi mdi-linkedin text-indigo-700 mx-auto mt-2" />
                          </a>
                          {/* Twitter */}
                          <button onClick={() => window.location.href = 'mailto:2019csb1126@iitrpr.ac.in'}  className="focus:outline-none cursor-pointer flex rounded-full hover:bg-blue-50 h-10 w-10">
                            <i className="mdi mdi-email text-blue-400 mx-auto mt-2" />
                          </button>
                          {/* Instagram */}
                          <a href="#" className="flex rounded-full hover:bg-orange-50 h-10 w-10">
                ...
                <div className="flex flex-wrap justify-center text-center mt-20">
                  <div className="w-full lg:w-6/12 px-4">
                    ...
                    For any inputs/comments, kindly contact:  <span className="cursor-pointer text-blue-700 font-normal" onClick={() => window.location.href = 'mailto:ipsa@iitrpr.ac.in'}>ipsa@iitrpr.ac.in</span>, <span className="cursor-pointer text-blue-700 font-normal" onClick={() => window.location.href = 'mailto:puneet@iitrpr.ac.in'}>puneet@iitrpr.ac.in</span>
                    </p>
                  </div>
                </div>
              </div>
