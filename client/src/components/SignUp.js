                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <form>
                    ...
                    <div className="text-center mt-6">
                      <button  onClick={() => props.decreasePageNumber()} className="bg-[#1E3A8A] w-full py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105" type="button" style={{transition: 'all 0.15s ease 0s'}}>Sign Up</button>
                    </div>
                  </form>
                </div>
              </div>
