            ...
            <div className="container mx-auto my-4 px-4 lg:px-20">
              <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                ...
                <div className="my-2 w-1/2 lg:w-1/4">
                  <button className="uppercase text-sm font-bold tracking-wide bg-[#1E3A8A] text-gray-100 p-3 rounded-lg w-full 
              ...
              <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-[#1E3A8A] rounded-2xl">
                <div className="flex flex-col text-white">
                  <h1 className="font-bold uppercase text-4xl my-4">Contact Details</h1>
                  <p className="text-gray-400 text-xl">Indian Institute of Technology Ropar, Rupnagar,Punjab - 140001,India
                  </p>
