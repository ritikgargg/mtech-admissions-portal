        ...
        <footer className="text-center lg:text-left bg-[#1E3A8A] text-white">
          <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div className>
                ...
                <p className="mb-4">
                  <a href="#!">Snehita Well-being Cell</a>
                </p>
              </div>
              ...
              <div className>
                ...
                <p className="mb-4">
                  <a href="#!">Mathematics and Computing</a>
                </p>
                <p className="mb-4">
                  <a href="#!">Mechanical Engineering</a>
                </p>
                <p className="mb-4">
                  <a href="#!">Metallurgical and Material Sciences</a>
                </p>
                <p className="mb-4">
                  <a href="#!">Physics</a>
                </p>
          ...
          <div className="text-center p-6 bg-[#1E3A8A]">
            ...
            <a className="font-semibold" href="https://tailwind-elements.com/">IIT Ropar</a>
          </div>
        </footer>
      );
      }
