...
function SignUp(props){
    return(
      ...
      <section className="absolute w-full top-0">
        <div className="absolute top-0 w-full h-full bg-gray-900" style={{backgroundImage: 'url("https://demos.creative-tim.com/tailwindcss-starter-project/static/media/register_bg_2.2fee0b50.png")', backgroundSize: '100%', backgroundRepeat: 'no-repeat'}} />
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <form>
                    ...
                    <div className="text-center mt-6">
                      <button className="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" type="button" style={{transition: 'all 0.15s ease 0s'}}>Sign In</button>
                    </div>
                  </form>
                </div>
              </div>
